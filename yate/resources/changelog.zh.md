...
- add yate ui smoke test tool [缺中文] ([`47dac93`](https://gitee.com/jermaine/yate/commit/47dac9311ad21b91a2aa1552716d19e1529dd3fc))

### 问题修复

- replace Get-FileHash: use native .NET SHA256 API instead to fix hash calculation failure due to PSModulePath pollution from host IDE, guarantee proper file hash generation. [缺中文] ([`0d06e94`](https://gitee.com/jermaine/yate/commit/0d06e947ec7e94324a978584da388fe02e21a97a))
...
- update the changelog [缺中文] ([`798df3a`](https://gitee.com/jermaine/yate/commit/798df3a6a16ab03f370b5f2a707f6e08c54d2c74))
...
- Populate all the color scheme with prompts [缺中文] ([`8ae5da6`](https://gitee.com/jermaine/yate/commit/8ae5da6d5df1277b97dc56195abcea1d4107855a))

### 问题修复

- resolve race in test_app_textual [缺中文] ([`6bb2179`](https://gitee.com/jermaine/yate/commit/6bb21799d9984e30a56f4fb24604ba1da9c5ea53))
- exclude release doc commits from entries to keep gate stable [缺中文] ([`677f867`](https://gitee.com/jermaine/yate/commit/677f867fad1319041e5c41e4a618d42709771114))

### 构建与工程

- Update overlay_theme_consistency_plan [缺中文] ([`e3e5a37`](https://gitee.com/jermaine/yate/commit/e3e5a376f7acef8fa8e5be8c9d2b1ad136c0eada))
- Update AI docs, change into English [缺中文] ([`e065440`](https://gitee.com/jermaine/yate/commit/e065440e92968a594e682a5cb3c3ff6145dcc33e))
- add AI docs [缺中文] ([`f056703`](https://gitee.com/jermaine/yate/commit/f05670327ed749bebca277f3cb9bc35cbe42defe))
- ignore .python-version file, in case of pyenv local config [缺中文] ([`adae5f7`](https://gitee.com/jermaine/yate/commit/adae5f71f65f33894dfc276674c5eab8bbc8d913))
...
- migrate suite from unittest to pytest with isolated HOME [缺中文] ([`14e6dd3`](https://gitee.com/jermaine/yate/commit/14e6dd372dbc3ecaadc52c2080a403eb5555599f))
